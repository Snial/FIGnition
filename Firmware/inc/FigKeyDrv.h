...
typedef enum {
	...
	kKeyStateDouble,
	kKeyStateSingle,
	kKeyStateSingleAfterDouble
}tKeyState;

#define kKeyStateKeyHit 4

extern byte gKey;
extern byte gKeyGroup;
extern byte gShiftState;
...
extern const byte gKeyCode[2][8][8] PROGMEM;
...
extern tKeyState gKeyState;

#define KeyHit(ch) gKey=ch;
